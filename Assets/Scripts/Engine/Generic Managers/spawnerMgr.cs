...
public class spawnerMgr : MonoBehaviour {
    ...
    public GameObject createGameObject(GameObject prefab)
    {
        ...
        if (newObject == null)
        {
            ...
            newObject.transform.parent = Managers.GetInstance.SceneMgr.rootScene.transform;
        }
    ...
    public void destroyGameObject(GameObject prefab, bool destroy = false)
    {
        if (!destroy)
        {
            ...
            prefab.transform.parent = Managers.GetInstance.SceneMgr.rootScene.transform;
    ...
    public void instanciateInitialObjects(prebuildObjects initialObjects)
    {
        ...
        foreach( prebuildObjects.initialObjects cacheInitial in initialObjects.cacheInitialObjects)
        {
            ...
            for (int i = 0; i < cacheInitial.size; ++i)
            {
                ...
                go.transform.parent = Managers.GetInstance.SceneMgr.rootScene.transform;
            }
