...
public class gameMgr : MonoBehaviour {
    ...
    public void gameOver()
    {
        ...
        Managers.sceneMgr.addState(sceneMgr.states.gameOver);
    }
    ...
    public void finishLevel()
    {
        ...
        Managers.sceneMgr.addState(sceneMgr.states.completeLevel);
    }

    public void initGame()
    {
        //Ponemos en la pila de estados que almaceno en el sceneMgr el estado game
        Managers.sceneMgr.addState(sceneMgr.states.game);
