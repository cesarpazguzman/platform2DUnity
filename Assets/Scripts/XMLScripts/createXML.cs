...
public class createXML
{
    public void generateNewXML(GameObject level)
    {
        ...
        time.seconds = level.GetComponent<definingLevel>().seconds;

        structureXML.SpawnPoint spawnPoint = new structureXML.SpawnPoint();
        spawnPoint.x = level.GetComponent<definingLevel>().spawnPoint.x;
        spawnPoint.y = level.GetComponent<definingLevel>().spawnPoint.y;
